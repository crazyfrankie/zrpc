...
type HelloServiceClient interface {
	HelloWorld(ctx context.Context, in *HelloRequest) (*HelloResponse, error)
}
...
func (c *helloServiceClient) HelloWorld(ctx context.Context, in *HelloRequest) (*HelloResponse, error) {
	out := new(HelloResponse)
	err := c.cli.Invoke(ctx, HelloService_HelloWorld_FullMethodName, in, out)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedHelloServiceServer) HelloWorld(context.Context, *HelloRequest) (*HelloResponse, error) {
	return nil, fmt.Errorf("method HelloWorld not implemented")
}
